				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="categorylist">
							...
							<tbody>
								<s:iterator value="#request.plist.result" id="res">
									
									<tr>
										<td><s:property value="#res.id" /></td>
										<td><s:property value="#res.paperName" /></td>
										<td><s:property value="#res.getAmountOfQuestion()" /></td>
										<td><s:property value="#res.getDuration()/60" /></td>
										<td><s:property value="#res.creator" /></td>
										<td><s:property value="#res.createDTime" /></td>
										<td><s:property value="#res.id" /></td>
										<td><s:property value="#res.status" /></td>
										<td class="center">
											<button class="btn btn-warning">
												修改 <i class="icon-pencil icon-white"></i>
											</button> <a href="./delpaper?paperId=<s:property value="#res.id" />"><button class="btn btn-danger">
						...
						<div class="pagination pagination-centered">
							<ul>
								...
								<s:bean name="org.apache.struts2.util.Counter" id="counter">
									...
									<s:param name="last" value="%{#request.plist.pageNum}" />
									<s:iterator>
										<li><a href="./listpaper?pageIndex=<s:property />"><s:property /></a></li>
									</s:iterator>
								</s:bean>
