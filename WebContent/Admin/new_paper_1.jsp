		...
		<div class="row-fluid">
			...
			<div class="span9" id="content">
				<div class="panel panel-primary">
					<div class="panel-heading"><h3>创建新的考试试卷</h3></div>
					<div class="panel-body">
						<form action="manual2" method="post" id="newpaperform">
							<div class="control-group">
								<label class="control-label" for="inputPaperName"><h4>试卷名称</h4></label>
								<div class="controls">
									<input type="text" id="inputPaperName" name="paper.paperName" placeholder="请输入试卷名称">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputDuration"><h4>考试时长（分钟）</h4></label>
								<div class="controls">
									<input type="number" id="inputDuration" name="paper.duration" placeholder="请输入考试时长，单位为分钟">
								</div>
							</div>
