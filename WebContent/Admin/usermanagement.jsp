				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="categorylist">
							...
							<tbody>
								<s:iterator value="#request.userlist.result" id="res">
									<tr>
										<td><s:property value="#res.loginId" /></td>
										<td><s:property value="#res.displayName" /></td>
										<td><s:property value="#res.password" /></td>
										<td class="center">
											<button class="btn btn-warning">
												修改 <i class="icon-pencil icon-white"></i>
											</button> <a href="./deluser?id=<s:property value="id" />"><button class="btn btn-danger">
						...
						<div class="pagination pagination-centered">
							<ul>
								...
								<s:bean name="org.apache.struts2.util.Counter" id="counter">
									...
									<s:param name="last" value="%{#request.userlist.pageNum}" />
									<s:iterator>
										<li><a href="./listuser?pageIndex=<s:property />"><s:property /></a></li>
									</s:iterator>
								</s:bean>
