        ...
        <div class="container-fluid">
			...
			<div class="span9" id="content">
				<div class="panel panel-primary">
					<div class="panel-heading">题目主题维护</div>
					<div class="panel-body">
						<form action="addsubject" method="post" id="subform">
							<p>
								主题名：<input type="text" class="form-control" id="subjectName" name="subjectName" placeholder="">
							</p>
						...
						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="categorylist">
							...
							<tbody>
								<s:iterator value="#request.subjects" id="sub">
									<tr>
										<td><s:property value="#sub.id" /></td>
										<td><s:property value="#sub.subjectName" /></td>
										<td class="center">
											<button class="btn btn-warning">
												修改 <i class="icon-pencil icon-white"></i>
											</button> <a href="./delsubject?subjectId=<s:property value="#sub.id" />"><button class="btn btn-danger">
