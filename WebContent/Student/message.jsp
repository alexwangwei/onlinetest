		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="index.html"> <i class="icon-dashboard"></i> <span class="menu-text"> 考试任务 </span>
					</a></li>
			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							考试任务 <small> <i class="icon-double-angle-right"></i> 考前提醒
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="span12">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="smaller">
										<i class="icon-quote-left smaller-80"></i> 考试注意事项
									</h4>
								</div>
										...
										<div class="row">
											<div class="col-xs-12">
												<ul class="list-unstyled spaced">
													<li><i class="icon-bell bigger-110 purple"></i> 考试一旦开始，系统将自动倒计时，计时结束系统将自动提交考卷。</li>
													<li><i class="icon-bell bigger-110 purple"></i> 考生若提前做完所有题目，可自行点击提交考卷按钮提前提交考卷，考卷一旦提交将不能再做任何修改。</li>
												</ul>
											</div>
										</div>
									</div>
					...
					<div class="row">
						<div class="span12 text-center">
							<a href=doexam?tid=<s:property value="#request.tid" />&qid=1>
							<button class="btn btn-primary">
								<i class="icon-pencil align-top bigger-125"></i> 开始作答
							</button>
							</a>
						</div>
					</div>
