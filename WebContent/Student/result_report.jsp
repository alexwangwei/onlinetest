			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							报告 <small> <i class="icon-double-angle-right"></i> 考试成绩报告
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="col-xs-12">
							<div class="table-responsive">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="#request.rrs" id="rr">
											<tr>
											<td><a href="#"><s:property value="#rr.task.taskName" /></a></td>
											<td><s:date name="#rr.finishDate" format="yyyy-MM-dd HH:mm:ss" /></td>
											<td><s:property value="#rr.amountOfQuestion" /></td>
											<td><s:property value="#rr.amountOfRight" /></td>
											<td><s:property value="#rr.totalValue" /></td>
											<td><s:property value="#rr.actualValue" /></td>
											<td><s:property value="#rr.percentageOfPass" />%</td>
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													<a href="#"><button class="btn btn-xs btn-info data-toggle="tooltip" data-placement="left" title="点击查看详情">
														<i class="icon-eye-open bigger-120" alt="aa"></i>
													</button></a>
												</div>
											</td>
										</tr>
