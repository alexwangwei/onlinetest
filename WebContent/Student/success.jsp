			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a href="#" class="dropdown-toggle"> <i class="icon-desktop"></i> <span class="menu-text"> 报告 </span> <b class="arrow icon-angle-down"></b>
						...
						<ul class="submenu">
							<li><a href="#"> <i class="icon-double-angle-right"></i> 考试成绩报告
							</a></li>
						...
						<div class="span12">
							<div class="widget-box">
								<div class="widget-header widget-header-flat">
									<h4 class="smaller">
										<i class="icon-quote-left smaller-80"></i> 系统提示
									</h4>
								</div>
										...
										<div class="row">
											<div class="col-xs-12">
												<ul class="list-unstyled spaced">
													<li><i class="icon-ok bigger-150 green"></i> 考卷提交成功！。</li>
																				</ul>
											</div>
										</div>
									</div>
					...
					<div class="row">
						<div class="span12 text-center">
							...
							<button class="btn btn-primary">
								<i class="icon-pencil align-top bigger-125"></i> 返回首页
							</button>
							</a>
						</div>
					</div>
